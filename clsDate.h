...
public:
    ...
    clsDate(string sDate)
    {
        ...
        vector <string> vDate;
        vDate = clsString::vSplitString(sDate, "/");
   ...
   void Print()
    ...
    {
        return NumberOfSecondsInAYear(Year);   // Fixed: was infinite recursion
    }
    ...
    {
        return DayOfWeekOrder(Day, Month, Year);   // Fixed: _Day, _Month -> Day, Month
    }
    ...
    string DayShortName()
    {
        ...
        return arrDayNames[DayOfWeekOrder(Day, Month, Year)];   // Fixed: _Day, _Month, _Year -> Day, Month, Year
    ...
    string MonthShortName()
    {
        ...
        return MonthShortName(Month);   // Fixed: _Month -> Month
    }
    ...
    {
        PrintMonthCalendar(Month, Year);   // Fixed: _Month, _Year -> Month, Year
    }
    ...
    {
        printf("\n  _________________________________\n\n");
        printf("           Calendar - %d\n", Year);   // Fixed: _Year -> Year
        printf("  _________________________________\n");


        for (int i = 1; i <= 12; i++)
        {
            PrintMonthCalendar(i, Year);   // Fixed: _Year -> Year
        }
    ...
    short DaysFromTheBeginingOfTheYear()
    {
        ...
        for (int i = 1; i <= Month - 1; i++)   // Fixed: _Month -> Month
        {
            TotalDays += NumberOfDaysInAMonth(i, Year);   // Fixed: _Year -> Year
        }

        TotalDays += Day;   // Fixed: _Day -> Day
